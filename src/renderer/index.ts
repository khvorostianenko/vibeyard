...
import { handlePtyData, destroyTerminal, updateCostDisplay, updateContextDisplay, refreshProfileLabels } from './components/terminal-pane.js';
...
async function main(): Promise<void> {
  ...
  // Theme application (CSS + terminals) is handled by theme-manager's
  // initTheme() above, which listens for preferences-changed/state-loaded.
  // Handle locale change: re-translate the open preferences modal in
