...
export const SHORTCUT_DEFAULTS: ShortcutDefault[] = [
  ...
  { id: 'increase-font-size', label: 'Increase Font Size', category: 'View', defaultKeys: 'Ctrl+=' },
  { id: 'decrease-font-size', label: 'Decrease Font Size', category: 'View', defaultKeys: 'Ctrl+-' },
  { id: 'reset-font-size', label: 'Reset Font Size', category: 'View', defaultKeys: 'Ctrl+0' },
